...
namespace StravaDiscordBot.ParticipantApi.StravaClient.Api
{
    ...
    public partial class AthletesApi : IAthletesApi
    {
        ...
        /// <returns></returns>
        public AthletesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< DetailedAthlete > GetLoggedInAthleteWithHttpInfo ()
        {
            ...
            {
                Exception exception = this.ExceptionFactory("GetLoggedInAthlete", localVarResponse);
        ...
        public ApiResponse< Zones > GetLoggedInAthleteZonesWithHttpInfo ()
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetLoggedInAthleteZones", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< ActivityStats > GetStatsWithHttpInfo (long? id)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetStats", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< DetailedAthlete > UpdateLoggedInAthleteWithHttpInfo (float? weight)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("UpdateLoggedInAthlete", localVarResponse);
                if (exception != null) throw exception;
            }
