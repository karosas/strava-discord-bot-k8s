...
namespace StravaDiscordBot.ParticipantApi.StravaClient.Api
{
    ...
    public partial class RunningRacesApi : IRunningRacesApi
    {
        ...
        /// <returns></returns>
        public RunningRacesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< RunningRace > GetRunningRaceByIdWithHttpInfo (long? id)
        {
            ...
            {
                Exception exception = this.ExceptionFactory("GetRunningRaceById", localVarResponse);
        ...
        public ApiResponse< List<RunningRace> > GetRunningRacesWithHttpInfo (int? year = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetRunningRaces", localVarResponse);
                if (exception != null) throw exception;
            }
