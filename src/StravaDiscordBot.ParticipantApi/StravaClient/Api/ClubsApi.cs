...
namespace StravaDiscordBot.ParticipantApi.StravaClient.Api
{
    ...
    public partial class ClubsApi : IClubsApi
    {
        ...
        /// <returns></returns>
        public ClubsApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< List<SummaryActivity> > GetClubActivitiesByIdWithHttpInfo (long? id, int? page = null, int? perPage = null)
        {
            ...
            {
                Exception exception = this.ExceptionFactory("GetClubActivitiesById", localVarResponse);
        ...
        public ApiResponse< List<SummaryAthlete> > GetClubAdminsByIdWithHttpInfo (long? id, int? page = null, int? perPage = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetClubAdminsById", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< DetailedClub > GetClubByIdWithHttpInfo (long? id)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetClubById", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< List<SummaryAthlete> > GetClubMembersByIdWithHttpInfo (long? id, int? page = null, int? perPage = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetClubMembersById", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        public ApiResponse< List<SummaryClub> > GetLoggedInAthleteClubsWithHttpInfo (int? page = null, int? perPage = null)
        {
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = this.ExceptionFactory("GetLoggedInAthleteClubs", localVarResponse);
                if (exception != null) throw exception;
            }
